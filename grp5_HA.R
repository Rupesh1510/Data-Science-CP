#1. Reference http: data.un.org. Data of GDP and GDP per capita
#2. Use suitable data visualization tools (minimum 2) to compare data of 5 appropriately contrasting countries.
#The assignment is to be implemented in R
